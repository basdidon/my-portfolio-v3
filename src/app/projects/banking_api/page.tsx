    ...
    return (
        <>
            <ProjectPage title="Banking API" githubUrl="https://github.com/basdidon/EventSourcing">
                ...
                {/* Bank Account */}
                <PageSection title="Events and Projection">
                    <PageSubSection title="BankAccount (Read model)">
                        ...
                        <ul className=" list-inside list-disc m-4">
                            ...
                            <li>
                                <span className=" font-bold text-yellow-300">OwnerId : </span>The
                    ...
                    <PageSubSection title="Events">
                        <p>
                            These immutable event records represent actions that occur over time.
                            They include:
                        </p>
                        <ul className=" list-inside list-disc my-4 space-y-2 mx-4">
                            <li>
                    ...
                    <PageSubSection title="BankAccountProjection">
                        <div className="md:px-4">
                            <PrismGist
                                codeLang="CSharp"
                ...
                <PageSection title="Withdrawal">
                    <p>
                        &emsp;&emsp;To prevent a Teller or Admin from arbitrarily withdrawing funds
                        from an account owned by a regular user, additional logic is required. When
                        a user intends to make a withdrawal, they must inform the Teller, who then
                        sends a withdrawal request to the server. The server generates and sends a
                        One-Time Password (OTP) to the user. The user provides the OTP to the
                        Teller, who then submits a withdrawal confirmation request to complete the
                        process.
                    </p>
                </PageSection>
                            ...
                            <tbody>
                                {projectApiDetails.map((x) => {
                                    ...
                                    return (
                                        ...
                                        >
                                            <td
                                                className={`py-2 px-5 font-bold ${methodTextColor}`}
                                            >
                                                {x.method}
                                            </td>
